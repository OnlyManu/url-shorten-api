...
import NavFooter, { LinkType } from "../nav-footer/nav-footer"

export default function Footer() {
    return (
        <div className={styles.container}>
            <div className={styles.logo_wrapper}>
                <svg xmlns="http://www.w3.org/2000/svg" width="121" height="33" viewBox="0 0 121 33" className={styles.logo}>
            ...
            <div className={styles.navlist}>
                ...
                <div className={styles.social_icons}>
                    ...
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 24" className={styles.icon}>
