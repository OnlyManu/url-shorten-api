        ...
        <div className={styles.container}>
            ...
            <div className={styles.navlist}>
                ...
                <div className={styles.social_icons}>
                    ...
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" className={styles.icon}>
